...
## Identification de l'étudiant
  Nom: Satnam Walia
  Courriel: satnam-singh.walia.1@ens.etsmtl.ca
  Code Moodle: LOG210-02
  Identifiant Github: satnam-walia
...
- j.nbLancersGagnés a été incrémenté si la totale de d1.valeur, d2.valeur et d3 .valeurest plus petit ou égale à 10
